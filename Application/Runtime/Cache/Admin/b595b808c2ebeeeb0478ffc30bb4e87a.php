...
<head>
    ...
    <meta name="keywords" content="蓝宝石后台">
    <meta name="description" content="蓝宝石后台">
...
<body class="fixed-sidebar full-height-layout gray-bg" style="overflow:hidden">
                        ...
                        <div class="dropdown profile-element">
                            ...
                            <a data-toggle="dropdown" class="dropdown-toggle" target="_top" href="#">
                               ...
                               <span class="block m-t-xs"><strong class="font-bold"><?php echo (session('username')); ?> </strong></span>
                                ...
                                编辑员<?php endif; ?><b class="caret"></b></span>
                                </span>
                            </a>
 ...
 -->
    ...
    <script src="/Application/Admin/View/Public/js/plugins/metisMenu/jquery.metisMenu.js"></script>
    <script src="/Application/Admin/View/Public/js/plugins/slimscroll/jquery.slimscroll.min.js"></script>
    <script src="/Application/Admin/View/Public/js/plugins/layer/layer.min.js"></script>
    <script src="/Application/Admin/View/Public/js/hplus.min.js"></script>
    <script type="text/javascript" src="/Application/Admin/View/Public/js/contabs.min.js"></script>
    <script src="/Application/Admin/View/Public/js/plugins/pace/pace.min.js"></script>
</body>
</html>