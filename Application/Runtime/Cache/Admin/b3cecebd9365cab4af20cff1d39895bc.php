    ...
    <div class="wrapper wrapper-content animated fadeInRight">
        <div class="row">
            <div class="col-sm-12">
              ...
              <form action="<?php echo U('Admin/News/updateinfo');?>" class="form-horizontal m-t" id="signupForm" method="post" enctype="multipart/form-data">              

                        <table class="table table-striped table-bordered table-hover dataTables-example">
                            <tbody>
                                    
                                <input type="hidden" name="id" value="<?php echo ($data["id"]); ?>"/>    
                                <div class="select_cate" select_cate="<?php echo ($data["cateid"]); ?>"></div>
                                    ...
                                    <td>
                                        <select class="form-control m-b" name="cateid">
                                         ...
                                         <script type="text/javascript">
                                                  ...
                                                  $(function(){
                                                      var select_cid= $('.select_cate').attr('select_cate');
                                                                         
                                                      var options =$('.m-b').find("option"); 
                                      
                                                       for(var i=1;i<=options.length;i++){
                                                          if (options.eq(i).val()==select_cid){
                                ...
                                <tr class="gradeA col-md  ">
                                    <td>文章标题</td>
                                    <td class="form-group"><input type="text" id="title" name="title" class="form-control m-input" placeholder="请输入标题" value="<?php echo ($data["title"]); ?>" required="" aria-required="true" minlength="2" maxlength="80" ></td>
                                   
                                </tr>
                                
                                  <div class="select_cid" select_cid="<?php echo ($data["type"]); ?>"></div>
                                 <tr class="gradeX col-md ">
                                    <td>所属类别</td>
                                    <td>
                                     <div class="radio i-checks">
                                           <input type="radio"  name="type" value="1"> <i></i> 头条
                                           <input type="radio"  name="type" value="2"> <i></i> 热点
                                           <input type="radio"  name="type" value="3"> <i></i> 普通
                                    </div>
                                       <script type="text/javascript">
                                              $(function(){
                                                  var select_cid= $('.select_cid').attr('select_cid');              
                                                  var options =$("input[type='radio']");  
                                                   for(var i=0;i<=options.length;i++){
                                                      if (options.eq(i).val()==select_cid){
                                                         options.eq(i).attr("checked", true);
                                                         options.eq(i).parent('div').addClass('checked');
                                                      }                                                                              
                                                    }
                                              })
                                        </script>
                                 ...
                                 <tr class="gradeX col-md ">
                                    <td>文章来源(50字以内)</td>
                                    <td class="form-group"><input type="text" id="source" name="source"    maxlength="10" class="form-control m-input" placeholder="请输入tag" value="<?php echo ($data["source"]); ?>"  required="" aria-required="true">
     ...
     <tr class="gradeA col-md ">
        ...
        <td>
         ...
         <div id="allimages" style="display:none">
             ...
             <?php if(!empty($data['desc_image'])): if(is_array($data['desc_image'])): foreach($data['desc_image'] as $key=>$vo): ?><input type="text" name="desc_image[]" class="hd-w200 ipt3" value="<?php echo ($vo); ?>"><?php endforeach; endif; ?>
             <?php else: ?>
                  <input type="text" name="desc_image[]" class="hd-w200 ipt3" value=""><?php endif; ?>
            ...
            <div id="uploadList">
                <ul>
                      <?php if(!empty($data['desc_image'])): if(is_array($data['desc_image'])): foreach($data['desc_image'] as $key=>$vo): ?><li path="<?php echo ($vo); ?>" ><img src="<?php echo ($vo); ?>" class="hd-w120 hd-h100"></li><?php endforeach; endif; endif; ?>
                </ul>
            </div>
                          ...
                          success:function(data){
                            if(data.status==true){
                                ...
                                swal({title:"太帅了",text:"已删除",type:"success"})
                                   ...
                                   <tr class="gradeX col-md ">
                                    <td>关键词(50字以内)</td>
                                    <td class="form-group"><input type="text" id="keywords" name="keywords"   minlength="2" maxlength="80" class="form-control m-input" placeholder="请输入标题" value="<?php echo ($data["keywords"]); ?>"  required="" aria-required="true">
                                 ...
                                 <tr class="gradeX col-md">
                                    <td>文章描述(100字内)</td>
                                    <td class="form-group"><textarea type="text" name="description" class="form-control m-input" placeholder="请输入标题"  minlength="2" maxlength="120"  required="" aria-required="true"style="resize:none;"><?php echo ($data["description"]); ?></textarea></td>
                                   
                                </tr>

                                <tr class="gradeX col-md ">
                                    <td>TAG标签(50字以内)</td>
                                    <td class="form-group"><input type="text" id="tag" name="tag"   maxlength="20" maxlength="80" class="form-control m-input" placeholder="请输入tag" value="<?php echo ($data["tag"]); ?>"  required="" aria-required="true">
                                ...
                                <tr class="gradeC">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input class="form-control layer-date" placeholder="YYYY-MM-DD hh:mm:ss" onclick="laydate({istime: true, format: 'YYYY-MM-DD hh:mm:ss'})" name="time" value="<?php echo (date('Y-m-d H:i:s',$data["time"])); ?>" >
                                ...
                                <tr class="gradeX col-md">
                                    <td>正文内容</td>
                                    <td><textarea type="text" name="content" id="editor" placeholder="请输入标题"><?php echo ($data["content"]); ?></textarea></td>
