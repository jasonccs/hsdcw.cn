...
<div id="subHot" bosszone="js_jdt">
       ...
       <?php
 if(!isset($newtop['id'])){ echo '<a target="_blank" href="#">'; }else{ echo '<a target="_blank" href="<?php echo U('.'/H_N_d/'.$newtop['id'].');?>">'; } if(preg_match('/|/',$newtop['desc_image']) && $newtop['desc_image'] != ''){ $list_top_img=explode('|', $newtop['desc_image']); echo '<img src="'. $list_top_img[0].'" alt="'.$newtop['title'].'" width="750" height="346">'; }else{ echo '<img src="/Application/Home/View/Public/images/default.png" alt="'.$newtop['title'].'" width="100%" height="100%">'; }; ?>
		<!--  -->
